...
These notes provide detailed instructions for installing `libeemd` itself especially on Windows environment. Similar steps are also needed if you want to install `Rlibeemd` for source on Windows environment.
...
Again, we first need to install `GSL`. Unfortunately this is not as straightforward as in Linux. I will first describe the couple shortcuts, and the describe the typical approach.
